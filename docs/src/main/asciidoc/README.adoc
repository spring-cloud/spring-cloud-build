...
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-build/3.0.x/docs/src/main/asciidoc/contributing.adoc[]
...
[source,xml]
----
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-build/3.0.x/pom.xml[tags=attributes,indent=0]
----
